...
<?php
 ...
 ?>
    ...
    <form class="form-horizontal" action="<?php echo base_url()?>page/orderselesai" method="post" name="frmCO" id="frmCO">
        ...
        <div class="modal-body">
            ...
            <i class="fa fa-hospital-o"></i> TakeCare, Inc.
            <small class="pull-right">Date: <?php echo date('d / M / y');?></small>
                ...
                <div class="row invoice-info">
                    <div class="col-sm-4 invoice-col">
                        From
                        <address>
            <strong>TakeCare, Inc.</strong><br>
            Jl.Jend. Gatot Subroto No.123 Bandung<br>
