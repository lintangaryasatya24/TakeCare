        ...
        <?php $no=1; foreach ($data as $row ) {?>
            <tr>
                ...
                <form action="">
                    ...
                    <td>
                        <img width="250px" height="250px" src="<?php echo base_url() . 'assets/obat/'.$row['gambar']; ?>">
                    </td>
                    <td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                    ...
                    <form method="post" action="<?php echo base_url('page/editobat/'); ?> " enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Deskripsi Obat" name="deskripsi" value="<?php echo$d['deskripsi'];?>" required>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn btn-primary" id="simpan" value="Submit" placeholder="Simpan">
                </div>
                </form>
            </div>
        </div>
